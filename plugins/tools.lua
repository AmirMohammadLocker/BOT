...
local sudo_users = _config.sudo_users
  if not lang then
 text = "L̸i̸s̸t̸ o̸f̸ s̸u̸d̸o̸ u̸s̸e̸r̸s̸ :\n"
   else
...
local sudo_users = _config.sudo_users
  if not lang then
 text = 'L̸i̸s̸t̸ o̸f̸ b̸o̸t̸ a̸d̸m̸i̸n̸s̸ :\n'
   else
 text = "_لیست ادمین های ربات :_\n"
   ...
   if not lang then
		  		text = 'N̸o̸ *a̸d̸m̸i̸n̸s̸* a̸v̸a̸i̸l̸a̸b̸l̸e̸'
      else
...
local function chat_list(msg)
    ...
    local message = 'L̸i̸s̸t̸ o̸f̸ G̸r̸o̸u̸p̸s̸:\nU̸s̸e̸ #j̸o̸i̸n̸ (I̸D̸) t̸o̸ j̸o̸i̸n̸\n\n'
	...
	local d = math.floor(expiretime / 86400) + 1
        if tonumber(d) == 1 and not is_sudo(msg) and is_mod(msg) then
			if lang then
				...
				tdcli.sendMessage(msg.to.id, 0, 1, 'G̸r̸o̸u̸p̸ 1̸ d̸a̸y̸ r̸e̸m̸a̸i̸n̸i̸n̸g̸ c̸h̸a̸r̸g̸e̸, t̸o̸ r̸e̸c̸h̸a̸r̸g̸e̸ t̸h̸e̸ r̸o̸b̸o̸t̸ c̸o̸n̸t̸a̸c̸t̸ w̸i̸t̸h̸ t̸h̸e̸ s̸u̸d̸o̸. W̸i̸t̸h̸ t̸h̸e̸ c̸o̸m̸p̸l̸e̸t̸i̸o̸n̸ o̸f̸ c̸h̸a̸r̸g̸i̸n̸g̸ t̸i̸m̸e̸, t̸h̸e̸ g̸r̸o̸u̸p̸ r̸e̸m̸o̸v̸e̸d̸ f̸r̸o̸m̸ t̸h̸e̸ r̸o̸b̸o̸t̸ l̸i̸s̸t̸ a̸n̸d̸ t̸h̸e̸ r̸o̸b̸o̸t̸ w̸i̸l̸l̸ l̸e̸a̸v̸e̸ t̸h̸e̸ g̸r̸o̸u̸p̸.', 1, 'md')
			end
		end
	end
end
...
if is_admin1(tonumber(data.id_)) then
   if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*✦Done!*\n ✯U̸s̸e̸r̸ `["..user_name.."]` I̸D̸ `["..data.id_.."]`i̸s̸ a̸l̸r̸e̸a̸d̸y̸ a̸n̸ #*a̸d̸m̸i̸n̸*", 0, "md")
  else
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* _از قبل ادمین ربات بود_", 0, "md")
		...
		save_config()
     if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*✦Done!*\n ✯U̸s̸e̸r̸ `["..user_name.."]` I̸D̸ `["..data.id_.."] h̸a̸s̸ b̸e̸e̸n̸ P̸r̸o̸m̸o̸t̸e̸d̸ a̸s̸ #*a̸d̸m̸i̸n̸*", 0, "md")
    else
...
if not is_admin1(data.id_) then
   if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*✦Done!*\n ✯U̸s̸e̸r̸ `["..user_name.."]` I̸D̸ `["..data.id_.."] i̸s̸ N̸o̸t̸ a̸ #*a̸d̸m̸i̸n̸*", 0, "md")
   else
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* _از قبل ادمین ربات نبود_", 0, "md")
		...
		save_config()
    if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*✦Done!*\n ✯U̸s̸e̸r̸ `["..user_name.."]` I̸D̸ `["..data.id_.."] h̸a̸s̸ b̸e̸e̸n̸ d̸e̸m̸o̸t̸e̸d̸ f̸r̸o̸m̸ #*a̸d̸m̸i̸n̸*", 0, "md")
   else
...
if already_sudo(tonumber(data.id_)) then
  if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*✦Done!*\n ✯U̸s̸e̸r̸ `["..user_name.."]` I̸D̸ `["..data.id_.."] i̸s̸ a̸l̸r̸e̸a̸d̸y̸ a̸ *S̸u̸d̸o̸e̸r̸*", 0, "md")
   else
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* _از قبل سودو ربات بود_", 0, "md")
     ...
     reload_plugins(true)
  if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*✦Done!*\n ✯U̸s̸e̸r̸ `["..user_name.."]` I̸D̸ `["..data.id_.."] i̸s̸ n̸o̸w̸ *S̸u̸d̸o̸e̸r̸*", 0, "md")
  else
...
user_name = check_markdown(data.first_name_)
   ...
   if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*✦Done!*\n ✯U̸s̸e̸r̸ `["..user_name.."]` I̸D̸ `["..data.id_.."] i̸s̸ N̸o̸t̸ a̸ *S̸u̸d̸o̸e̸r̸*", 0, "md")
   else
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* _از قبل سودو ربات نبود_", 0, "md")
     ...
     reload_plugins(true) 
   if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*✦Done!*\n ✯U̸s̸e̸r̸ `["..user_name.."]` I̸D̸ `["..data.id_.."] i̸s̸ N̸o̸ l̸o̸n̸g̸e̸r̸ a̸ *S̸u̸d̸o̸e̸r̸*", 0, "md")
   else
	...
	if msg.to.type ~= 'pv' then
		...
		if gpst and not chex and msg.from.id ~= SUDO and not is_sudo(msg) then
			...
			if lang then
				...
				tdcli.sendMessage(msg.to.id, msg.id_, 1, 'G̸r̸o̸u̸p̸ c̸h̸a̸r̸g̸e̸d̸ 1̸ d̸a̸y̸. t̸o̸ r̸e̸c̸h̸a̸r̸g̸e̸ t̸h̸e̸ r̸o̸b̸o̸t̸ c̸o̸n̸t̸a̸c̸t̸ w̸i̸t̸h̸ t̸h̸e̸ s̸u̸d̸o̸. W̸i̸t̸h̸ t̸h̸e̸ c̸o̸m̸p̸l̸e̸t̸i̸o̸n̸ o̸f̸ c̸h̸a̸r̸g̸i̸n̸g̸ t̸i̸m̸e̸, t̸h̸e̸ g̸r̸o̸u̸p̸ r̸e̸m̸o̸v̸e̸d̸ f̸r̸o̸m̸ t̸h̸e̸ r̸o̸b̸o̸t̸ l̸i̸s̸t̸ a̸n̸d̸ t̸h̸e̸ r̸o̸b̸o̸t̸ w̸i̸l̸l̸ l̸e̸a̸v̸e̸ t̸h̸e̸ g̸r̸o̸u̸p̸.', 1, 'md')
			end
		end
...
if is_sudo(msg) then
   		if ((matches[1]:lower() == 'add' and not Clang) or (matches[1] == "افزودن" and Clang)) and not redis:get('ExpireDate:'..msg.to.id) then
			redis:set('ExpireDate:'..msg.to.id,true)
			redis:setex('ExpireDate:'..msg.to.id, 1899, true)
				...
				if lang then
					...
					tdcli.sendMessage(msg.to.id, msg.id_, 1, '*✦Done!* \n G̸r̸o̸u̸p̸ c̸h̸a̸r̸g̸e̸d̸ 3̸ d̸a̸y̸s̸ m̸i̸n̸u̸t̸e̸s̸ f̸o̸r̸ s̸e̸t̸t̸i̸n̸g̸s̸.', 1, 'md')
				end
		end
		...
		if ((matches[1] == 'leave' and not Clang) or (matches[1] == "خروج" and Clang)) and matches[2] then
			if lang then
				...
				tdcli.sendMessage(matches[2], 0, 1, '*✦Done!* \n R̸o̸b̸o̸t̸ l̸e̸f̸t̸ t̸h̸e̸ g̸r̸o̸u̸p̸\n̸*F̸o̸r̸ m̸o̸r̸e̸ i̸n̸f̸o̸r̸m̸a̸t̸i̸o̸n̸ c̸o̸n̸t̸a̸c̸t̸ T̸h̸e̸ S̸U̸D̸O̸.*', 1, 'md')
				tdcli.changeChatMemberStatus(matches[2], our_id, 'Left', dl_cb, nil)
				tdcli.sendMessage(SUDO, msg.id_, 1, '*✦Done!* \n R̸o̸b̸o̸t̸ l̸e̸f̸t̸ f̸r̸o̸m̸ u̸n̸d̸e̸r̸ g̸r̸o̸u̸p̸ s̸u̸c̸c̸e̸s̸s̸f̸u̸l̸l̸y̸:\n\n`'..matches[2]..'`', 1,'md')
			end
		end
...
if matches[1] == "راهنمای قفل ها" and not Clang and is_mod(msg) then
if not lang then
text = [[
بہ بخش ❶
خوش آمدید🌹
—-----راهنماے قفل ها-------
➤`/lock link`
❂ممنوع شدن ارسال لینک در گروه
➤`/unlock link`
❂اجازه دادن بہ ارسال لینک در گروه
—----------------------
➤`/lock tag`
❂ممنوع شدن ارسال تگ  درگروه
➤`/unlock tag`
❂اجازه دادن بہ ارسال تگ در گروه
—----------------------
➤`/lock edit`
❂ممنوع شدن ویرایش پیام در گروه
➤`/unlock edit`
❂اجازه دادن بہ ویرایش پیام در گروه
—----------------------
➤`/lock arabic`
❂ممنوع شدن ارسال کلمات عربی در گروه
➤`/unlock arabic`
❂اجازه دادن بہ استفاده از کلمات عربی در گروه
—----------------------
➤`/lock webpage`
❂ممنوع شدن ارسال صفحات سایت ها در گروه
➤`/unlock webpage`
❂اجازه دادن بہ ارسال صفحات سایت ها درگروه
—----------------------
➤`/lock bots`
❂ممنوع شدن ورود ربات ها بہ گروه
➤`/unlock bots`
❂اجازه دادن بہ ورود ربات ها بہ گروه
—----------------------
➤`/lock spam`
❂ممنوع شدن ارسال پیام پشت سرهم(رگباری)
➤`/unlock spam`
❂اجازه دادن بہ ارسال پیام پشت سرهم(رگباری)
—----------------------
➤`/lock flood`
❂تنظیم حساسیت ربات(قفل ها) در گروه
➤`unlock flood`
❂برداشتن حساسیت ربات نسبت بہ (قفل ها)
—----------------------
➤`/lock markdown`
❂ممنوع شدن ارسال صفحات فروشگاه
➤`/unlock markdown`
❂اجازه دادن بہ ارسال صفحات فروشگاه
—----------------------
➤`/lock mention`
❂ممنوع شدن استفاده از فونت هاے استاندارد
➤`/unlock mention`
❂اجازه دادن بہ استفاده از فونت هاے غیر استاندارد
—----------------------
➤`/lock pin`
❂ممنوع شدن سنجاق و اعلامیه در گروه
➤`/unlock pin`
❂اجازه دادن بہ سنجاق و اعلامیه در گروه		
]]..msg_caption
...
if matches[1] == "راهنمای بیصدا ها" and not Clang and is_mod(msg) then
if not lang then
text = [[
بہ بخش ❷
خوش آمدید🌹
...
----------------------
➺`/mute document`
❂بیصدا کردن پرونده (فایل)
➺`/unmute document`
❂باصدا کردن پرونده(فایل)
----------------------
➺`/mute  sticker`
❂بیصدا کردن استیکر
➺`/unmute sticker`
...
----------------------
➺`/mute video`
❂بیصدا کردن ویدیو(فیلم)
➺`/unmute video`
❂باصدا کردن ویدیو(فیلم)
----------------------
 ➺`/mute text`
❂بیصدا کردن متن(بلند)
➺`/unmute text`
...
if matches[1] == "راهنمای مدیران" and not Clang and is_mod(msg) then
if not lang then
text = [[
بہ بخش ❸
خوش آمدید🌹
...
➥`/setchar [Number]`
تنظیم حداکثر کاراکتر پیام پشت سرهم(رگباری)

➥`/setfloodtime [ 1 - 10 ]`
`تنظیم زمان ارسال پیام پشت سرهم(رگباری)`

`➥`/silent [username|id|reply]
`بیصدا کردن کاربر در گروه`

`➥`/unsilent [username|id|reply]
`درآوردن کاربر از لیست بیصدا`

`➥`/kick [username|id|reply]
`اخراج کاربر از گروه`
`➥`/ban [username|id|reply]
`مسدود همیشگی کاربر از گروه`
`➥`/unban [username|id|reply]
`درآوردن از لیست مسدود همیشگی گروه`
`➥`/whitelist [+|-] [username|id|reply]
`افزودن افراد به لیست سفید`
`➥`/res [username]
`نمایش شناسه عددی کاربر`
`➥`id [username][reply][id]
`نمایش مشخصات کامل کاربر`
`➥`whois [id]
`نمایش مشخصات کاربر`
`➥`/set rules
`ثبت قوانین گروه`
...
`ثبت درباره گروه`
`➥`/set welcome
`ثبت خوش آمدگویی ربات در گروه`
`➥`/filter [word]
`فیلتر کلمه مورد نظر`
`➥`/unfilter [word]
`در آوردن کلمه از لیست فیلتر`
`➥`/pin [reply]
`ربات پیام شمارا در گروه سنجاق خواهد کرد`
`➥`/unpin
`ربات پیام سنجاق شده را درگروه حذف خواهد کرد`
`➥`/welcome enable
`فعال کردن خوش آمدگویی ربات در گروه`
`➥`/welcome disable
`غیرفعال کردن خوش آمدگویی`
`➥`/rules
`نمایش قوانین ثبت شده گروه`
`➥`/about
`نمایش درباره گروه`
`➥`/gpinfo
`نمایش اطلاعات گروه`
`➥`/newlink
`ساخت لینک جدید براے گروه`
`➥`/setlink
`ثبت لینک جدید براے گروه`
`➥`/link
`نمایش لینک گروه`
`➥`/linkpv
`ارسال لینک گروه بہ چت خصوصی شما`
`➥`/setwelcome [text]
`ثبت پیام خوش آمدگویی`
`➥`setlang [ fa | en ]
`تنظیم زبان ربات بہ فارسی یا انگلیسی`
`➥`setcmd [ fa | en ]
`تنظیم زبان دستورات ربات بہ فارسی یه انگلیسی`
`------راهنماے رُبات لوکرتیم-------`
...
----راهنماے پاکسازے----
➥`/clean bans`
پاکسازے لیست مسدود همیشگی
➥`/clean mods`
پاکسازے مدیران
➥`/clean rules`
پاکسازے بخش قوانین
➥`/clean about`
پاکسازے بخش درباره گروه
➥`/clean silentlist`
پاکسازے بخش لیست بیصدا
➥`/clean filterlist`
پاکسازے لیست فیلتر(کلمات)
➥`/clean welcome`
پاکسازے خوش آمدگویی
-------------------
➥`/del all`
پاکسازے همه پیام هاے گروه (در حدتوان)
➥`/del [ 0 - 1000 ]`
پاکسازے پیام ها از 0 تا 1000
➥`/del me`
پاکسازے پیام هاے شما	
]]..msg_caption
tdcli.sendMessage(msg.chat_id_, 0, 1, text, 1, 'md')
else
text = [[
