...
if matches[1] == "راهنماے قفل ها" and not Clang and is_mod(msg) then
text = [[
بہ بخش ❶
خوش آمدید🌹
—-----راهنماے قفل ها-------
...
if matches[1] == "راهنماے بیصدا ها" and not Clang and is_mod(msg) then
text = [[
بہ بخش ❷
خوش آمدید🌹
-----راهنماے بیصدا ها-----
...
tdcli.sendMessage(msg.chat_id_, 0, 1, text, 1, 'md')
if matches[1] == "راهنماے مدیران" and not Clang and is_mod(msg) then
text = [[
بہ بخش ❸
خوش آمدید🌹
----راهنماے مدیران----
